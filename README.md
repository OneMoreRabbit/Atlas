...
- [`needs/`](needs/) — the method seat's outbox: findings and asks from @atlas addressed to project arch seats, read in place (every seat clones this repo). Answered/retired by the raiser like any need.
